...
namespace esphome
{
    namespace tx_ultimate_touch
    {
        ...
        const static uint8_t TOUCH_STATE_SWIPE_2 = 12;
        const static uint8_t TOUCH_STATE_SWIPE_1 = 13;
        ...
        public:
            ...
            Trigger<TouchPoint> *get_swipe_1_trigger() { return &this->swipe_trigger_1_; }
            Trigger<TouchPoint> *get_swipe_2_trigger() { return &this->swipe_trigger_2_; }
        ...
        protected:
            ...
            Trigger<TouchPoint> swipe_trigger_1_;
            Trigger<TouchPoint> swipe_trigger_2_;
